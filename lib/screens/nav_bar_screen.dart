import 'package:ecc/constants.dart';
import 'package:ecc/screens/Cart/cart_screen.dart';
import 'package:ecc/screens/Home/home_screen.dart';
import 'package:ecc/screens/favorite.dart';
      ...
      bottomNavigationBar: BottomAppBar(
        ...
        child: Row(
          ...
          children: [
            ...
            const SizedBox(width: 15), // Added const keyword
            IconButton(
              onPressed: () {
                setState(() {
                  currentIndex = 3;
